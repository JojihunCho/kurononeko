...
def display():
    ...
    rt = t * v
    Rt = Rotation.from_rotvec(rt)
    M = A*Rt

    cow2 = getTranslation(cow2wld2)
    cow1 = getTranslation(cow2wld1)

    now_cow = cow2 - cow1

    new_cow = now_cow * t + cow1
    
    cow2wld = matrix4(M.as_matrix(), new_cow)
    drawCow(cow2wld)
